...
class SellerRegistrationForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].widget.attrs['placeholder'] = 'Nombre de la empresa'
		...
		self.fields['password2'].help_text = '<span class="form-text text-muted"><small>Ingrese la contraseña como la anterior, para la verificación y validación.</small></span>'
